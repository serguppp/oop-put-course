...
RepurchaseWindowDrawer::RepurchaseWindowDrawer() {}

void RepurchaseWindowDrawer::Draw(sf::RenderWindow& window, const GameBoard* gameboard, sf::Font& font, int player_id) const {
    ...
    purchaseText.setString("Do you want to repurchase this field?\n It will cost $" + std::to_string(2*gameboard->getField(gameboard->getPlayer(player_id)->getPosition())->getCost()));
