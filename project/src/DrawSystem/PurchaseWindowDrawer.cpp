...
PurchaseWindowDrawer::PurchaseWindowDrawer() {}

void PurchaseWindowDrawer::Draw(sf::RenderWindow& window, const GameBoard* gameboard, sf::Font& font, int player_id) const {
    ...
    purchaseText.setString("Do you want to buy this field?\n It will cost $" + std::to_string(gameboard->getField(gameboard->getPlayer(player_id)->getPosition())->getCost()));
